...
import { paginateArray } from "@/components/graph/utils/pagination";
import { fieldMatchesText, flattenFields } from "./utils";
import {
    getNearestHandleRelations,
    getAllHandleRelations,
} from "@/components/graph/selection/utils/handleSelection";
import GraphSelectionContext from "@/components/graph/selection/GraphSelectionContext";
...
const DatasetSchemaTable = ({
    ...
    const { selection, setSelection } = useContext(GraphSelectionContext);
