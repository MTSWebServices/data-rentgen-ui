...
import useGraphSelectionProvider from "./selection/useGraphSelectionProvider";
import GraphSelectionContext from "./selection/GraphSelectionContext";
...
const Graph = (props: ReactFlowProps) => {
    ...
    const graphSelection = useGraphSelectionProvider();
    const { selection, setSelection, resetSelection } = graphSelection;
    ...
    return (
        <GraphSelectionContext.Provider value={graphSelection}>
            <ReactFlow
                className={
